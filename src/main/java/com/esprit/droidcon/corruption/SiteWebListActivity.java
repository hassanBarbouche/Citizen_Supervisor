...
public class SiteWebListActivity extends BaseActivity
		{
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.about:
			{
				Intent i = new Intent(SiteWebListActivity.this, AboutActivity.class);
				startActivity(i);
				finish();
			}
			break;
			...
			case R.id.HomeBtn:
			{
				Intent i = new Intent(SiteWebListActivity.this, Main.class);
				startActivity(i);
				finish();
			}
			break;

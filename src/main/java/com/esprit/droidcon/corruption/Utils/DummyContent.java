package com.esprit.droidcon.corruption.Utils;

import com.esprit.droidcon.corruption.models.DummyModel;
import com.esprit.droidcon.corruption.R;
import com.esprit.droidcon.corruption.models.ImageGalleryCategoryModel;
import com.esprit.droidcon.corruption.models.ImageGallerySubcategoryModel;
...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getDummyModelSwipeToDissmissTravelList() {
		...
		list.add(new DummyModel(0, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/0.jpg", "Tears In Heaven", R.string.fontello_heart_empty));
		list.add(new DummyModel(1, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/1.jpg", "Blowing In The Wind", R.string.fontello_heart_empty));
		list.add(new DummyModel(2, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/2.jpg", "Reptile", R.string.fontello_heart_empty));
		list.add(new DummyModel(3, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/3.jpg", "Build Me Up", R.string.fontello_heart_empty));
	...
	public static ArrayList<DummyModel> getSocialDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "", "Bureau d'ordre", R.string.material_icon_play));
		list.add(new DummyModel(1, "", "Etat Civile", R.string.material_icon_play));
		list.add(new DummyModel(2, "", "Relation Avec Le Cityoen", R.string.material_icon_play));
		list.add(new DummyModel(2, "", "Site Web", R.string.material_icon_play));
		list.add(new DummyModel(3, "", "Autre",R.string.material_icon_play));

		return list;
	}
	public static ArrayList<DummyModel> getSocialDummyListImage() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, R.drawable.boyred));
		list.add(new DummyModel(1, R.drawable.boyredflou));

		list.add(new DummyModel(5, R.drawable.boyred));
		return list;
	}

...
public class AutreListActivity extends BaseActivity
		{
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.about:
			{
				Intent i = new Intent(AutreListActivity.this, AboutActivity.class);
				startActivity(i);
				finish();
			}
			break;
			...
			case R.id.HomeBtn:
			{
				Intent i = new Intent(AutreListActivity.this, Main.class);
				startActivity(i);
				finish();
			}
			break;
